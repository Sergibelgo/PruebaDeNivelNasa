    ...
    public class AutoMapperProfiles:Profile
    {
        public AutoMapperProfiles()
        {
            ...
            CreateMap<Asteroid, AsteroidDTO>()
                ...
                .ForMember(dto => dto.Diametro, ent => ent.MapFrom(x => x.estimated_diameter.kilometers.estimated_diameter_max/x.estimated_diameter.kilometers.estimated_diameter_min));
        }
    }
}
